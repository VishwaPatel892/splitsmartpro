    ...
    <div className="relative z-10 w-full max-w-md animate-fade-up">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#1E293B]/70 backdrop-blur-xl shadow-2xl px-8 py-10 sm:px-10">
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-[#475569] font-medium">or continue with</span>
          <div className="flex-1 h-px bg-white/8" />
        </div>
        ...
        <button
          id="google-auth-btn"
          type="button"
          className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/10
                     bg-white text-gray-700 text-sm font-semibold py-2.5
